...
MEMORY_EXTRACTION_PROMPT = (
    ...
    "- themes_covered: list of 3-5 high-level theme tags ONLY (e.g., 'multi-agent', 'coordination'). "
    "Keep tags broad and reusable across posts. Do NOT include generic software terms "
    "like 'testing', 'debugging', 'refactoring', 'feature', 'api', 'cli'.\n"
