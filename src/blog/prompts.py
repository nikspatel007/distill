...
DAILY_SOCIAL_PROMPTS: dict[str, str] = {
    "linkedin": (
        ...
        "You are a solo founder building an AI content pipeline in public.\n\n"
        "HARD RULES:\n"
        "- 400-700 characters TOTAL. Shorter is better. If over 700, cut.\n"
        ...
        "STRUCTURE (3 parts, nothing more):\n"
        "1. Hook: one sentence, under 80 characters. A surprising number, "
        "a counterintuitive finding, or a bold claim. Not a question.\n"
        "2. Body: 2-3 sentences explaining what you built or discovered. "
        "Write like you are texting a smart friend. Be concrete but skip "
        "implementation details nobody cares about.\n"
        ...
        "'My AI pipeline now writes its own blog posts. Here is what went wrong.'\n\n"
        "WHAT NOT TO DO:\n"
        ...
        "HASHTAGS: last line, always: #BuildInPublic #DistillAI plus 1-2 more.\n\n"
        "Output ONLY the post text. Nothing else."
    ),
    "twitter": (
        "Convert this developer journal entry into a single tweet.\n\n"
        "You are a solo founder building an AI content pipeline.\n\n"
        "HARD RULES:\n"
